...
extern SemaphoreHandle_t USART1_RxSemaphore;
extern TaskHandle_t USART1_ReceiveTask_Handler;
//////////////////////////////////////////////////////////////////
...
//			printf("触发空闲中断\r\n");
        ...
        DMA_Cmd(DMA2_Stream5, DISABLE);  // 暂停当前 DMA 接收
        received_len = USART1_RX_BUF_SIZE - DMA_GetCurrDataCounter(DMA2_Stream5); // 计算已接收数据长度
//			printf("接收数据长度: %d\r\n",received_len);
        processing_buf = current_rx_buf; // 当前缓冲区置为处理状态
        current_rx_buf = 1 - current_rx_buf; // 切换到另一个缓冲区
        ...
        vTaskNotifyGiveFromISR(USART1_ReceiveTask_Handler, &xHigherPriorityTaskWoken);
