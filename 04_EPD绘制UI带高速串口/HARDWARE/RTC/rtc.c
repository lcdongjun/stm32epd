...
u8 My_RTC_Init(void)
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_PWR, ENABLE);//使能PWR时钟
    ...
    RTC_Init(&RTC_InitStructure);
		...
		RTC_Set_Time(19,21,56,RTC_H12_AM);	//设置时间
		RTC_Set_Date(24,11,16,3);		//设置日期
...
{ 
  ...
  EXTI_Init(&EXTI_InitStructure);//配置
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 10;//抢占优先级10,freertos可管理5-15
	NVIC_InitStructure.NVIC_IRQChannelSubPriority = 00;
...
{ 
  ...
  EXTI_Init(&EXTI_InitStructure);//配置
	...
	NVIC_InitTypeDef NVIC_InitStructure;
	NVIC_InitStructure.NVIC_IRQChannel = RTC_WKUP_IRQn;
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 10;//抢占优先级5,freertos可管理5-15
